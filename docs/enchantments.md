...
🎰Покупать их за опыт<br>

## 🧭 Команды чар
↔️/alchem соединить пыль<br>
✨️/tinker открытие меню для переработки чар в пыль<br>
🌎/enchanter открытие меню для кастомных зачарований<br>
